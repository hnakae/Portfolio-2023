...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 left-90 bg-opaque backdrop-blur-lg z-10 w-full h-[88px] px-16 py-8 font-medium flex text-dark items-center justify-between dark:text-light lg:px-16 md:px-12 sm:px-8">
      <button
      ...
      {isOpen ? (
        ...
        >
          <nav className="flex items-cente flex-col justify-center">
            <CustomMobileLink
              href="/"
              title="Home"
              className=""
